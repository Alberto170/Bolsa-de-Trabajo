...
<body>
    ...
    <h2>Catalogos</h2>
    <h2>Catalogo de Puestos</h2>
    <form action="Puestos.php" method="POST" name="form" id="form">
        <div class="container-form">
            ...
            <input type="text" name="name" id="name" placeholder="puesto" class="form-control my-3" value="<?php echo htmlspecialchars($nameQuery); ?>">
        </div>
