...
$firstField = "cveNacionalidad";
$secondField = "nacionalidad";
?>
...
<body>
    ...
    <h2>Catalogos</h2>
    <h2>Catalogo de Nacionalidades</h2>
    <form action="Nacionalidades.php" method="POST" name="form" id="form">
        <div class="container-form">
            ...
            <input type="text" name="name" id="name" placeholder="nacionalidad" class="form-control my-3" value="<?php echo htmlspecialchars($nameQuery); ?>">
        </div>
