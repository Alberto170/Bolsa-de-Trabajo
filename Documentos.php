...
$table = "Documentos";
$firstField = "cveDocumento";
$secondField = "documento";
?>
...
<body>
    ...
    if (isset($_POST["baja"])) {
        ...
        if ($row > 0) {
            ...
            $msg .= "<h4 class = 'text-danger text-center mt-4' >No existe registro eliminar.</h4>";
        }
    }
    ...
    <form action="Documentos.php" method="POST" name="form" id="form">
        <div class="container-form">
            ...
            <input type="text" name="name" id="name" placeholder="documento" class="form-control my-3" value="<?php echo htmlspecialchars($nameQuery); ?>">
        </div>
