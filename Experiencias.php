...
$table = "Experiencias";
$firstField = "cveExperiencia";
$secondField = "experiencia";
?>
...
<body>
    ...
    <h2>Catalogos</h2>
    <h2>Catalogo de Experiencias</h2>
    <form action="Experiencias.php" method="POST" name="form" id="form">
        <div class="container-form">
            ...
            <label for="name">Experiencia</label>
            <input type="text" name="name" id="name" placeholder="experiencia" class="form-control my-3" value="<?php echo htmlspecialchars($nameQuery); ?>">
        </div>
