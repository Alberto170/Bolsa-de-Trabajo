...
<body>
    ...
    <form action="Cursos.php" method="POST" name="form" id="form">
        <div class="container-form">
            ...
            <input type="text" name="name" id="name" placeholder="curso" class="form-control my-3" value="<?php echo htmlspecialchars($nameQuery); ?>">
        </div>
