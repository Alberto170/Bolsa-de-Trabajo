...
$table = "Escolaridades";
$firstField = "cveEscolaridad";
$secondField = "escolaridad";
?>
...
<body>
    ...
    <h2>Catalogos</h2>
    <h2>Catalogo de Escolaridades</h2>
    <form action="Escolaridades.php" method="POST" name="form" id="form">
        <div class="container-form">
            ...
            <input type="text" name="name" id="name" placeholder="escolaridad" class="form-control my-3" value="<?php echo htmlspecialchars($nameQuery); ?>">
        </div>
