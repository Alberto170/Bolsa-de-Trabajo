...
$table = "Departamentos";
$firstField = "cveDepartamento";
$secondField = "departamento";
?>
...
<body>
    ...
    <h2>Catalogos</h2>
    <h2>Catalogo de Departamentos</h2>
    <form action="Departamentos.php" method="POST" name="form" id="form">
        <div class="container-form">
            ...
            <input type="text" name="name" id="name" placeholder="departamento" class="form-control my-3" value="<?php echo htmlspecialchars($nameQuery); ?>">
        </div>
